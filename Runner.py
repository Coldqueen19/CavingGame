...
def bigMenu():
    ...
    if response.lower() == "getbettergear" or response.lower() == "get better gear" or response.lower() == "shop":
        ...
        response == input("Are you sure? You will lose all of your progress! This action will physically overrides the save file and if a copy is not made you will be unable to recoer your previous game/s")
